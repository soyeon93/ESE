...
void callback()
{
	...
	g_signal_connect(G_OBJECT(window_main_btn), "clicked", G_CALLBACK(destroy_timetable), NULL);
	g_signal_connect(G_OBJECT(window_saved_btn), "clicked", G_CALLBACK(destroy_calMajor), NULL);
